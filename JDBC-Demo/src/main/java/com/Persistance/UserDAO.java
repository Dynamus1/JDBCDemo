...
public class UserDAO implements CustomDAOInterface<User> {
    ...
    public Integer create(User user) {
        //note that this is a "create" method, however
        //we are inserting into our table
        try {
            ...
            //You need to advance the cursor once to access the first element
            rs.next();
    ...
    public User update(User user) {
        //here we are updating the DB for a user
    ...
    public User checkLoginInfo(String first_name, String last_name){
        try{
            ...
            if(rs.next() && rs.getString("last_name").equals(last_name)){
